...
// пустом full и т.п.). Есть накопленный текст и 4с тишины — отдаём его;
// текста нет 15с — снимаем SEEN_STREAM и пускаем в работу DOM-фолбэк.
...
// Повтор в C# разрешён только при NOT_SENT. SENDFAIL здесь больше не шлём,
// чтобы gateway не сделал параллельный RESEND и не продублировал сообщение.
